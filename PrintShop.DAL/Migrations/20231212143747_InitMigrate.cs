        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCompany = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrintSizeId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Variants_PrintSizes_PrintSizeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.PictureId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3ee80c76-4e52-479d-a3dd-767938dee0f1"), "1", "Admin", "ADMIN" },
                    { new Guid("878bdf23-2cc9-4028-848b-b1f45791572b"), "2", "Customer", "CUSTOMER" },
                    { new Guid("beab5cbb-876b-4b68-834e-5551f19714a8"), "3", "Creator", "CREATOR" }
                });
